...
def test_get_recent_news_items_for_chat_with_mark_as_sent(db_engine, db_data_news_items):
    ...
    db_service.mark_news_items_as_sent(news_items, [123], datetime.datetime.utcnow(), db_engine)
    ...
    db_service.mark_news_items_as_sent(news_items, [234], datetime.datetime.utcnow(), db_engine)
